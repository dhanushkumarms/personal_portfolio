      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-2">
            I craft stellar web applications using modern full stack technologies.
            From designing intuitive front-end interfaces to building robust back-end systems, I deliver solutions that are both beautiful and powerful.
          </p>
